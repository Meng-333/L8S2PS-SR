var roi = ee.Geometry.Point([22.0405, -27.5085]);
//roi坐标 +- 1 ；
var geomPoly = ee.Geometry.BBox(21.623, -27.122, 22.913, -27.511);
...
// 查询sen-1影像
var ROIs200_s1_summer = ee.ImageCollection('COPERNICUS/S1_GRD')
                    ...
                    //.filter(ee.Filter.eq('orbitProperties_pass', 'ASCENDING'))
			             ...
			             //.filter(ee.Filter.eq('resolution', 'H'))
		  	            ...
		  	            .select('VV')
print('ROIs200_s1_summer',ROIs200_s1_summer,ROIs200_s1_summer.mosaic(),ROIs200_s1_summer.size())
// Map.addLayer(ROIs200_s1_summer.mosaic().clip(ROIs100_landUrban_L2),{min:-30,max:5}, 'ROIs200_s1_summer.mosaic()')
Map.addLayer(ROIs200_s1_summer.mosaic(),{min:-30,max:5}, 'ROIs200_s1_summer.mosaic()')
...
// 查询sen-2影像
var ROIs200_s2_summer = ee.ImageCollection('COPERNICUS/S2_SR')       //L2A:表面反射率图像
                      .filterDate("2021-06-01","2021-08-31")    //筛选出指定时间内的影像
...
print('ROIs200_s2_summer',ROIs200_s2_summer,ROIs200_s2_summer.mosaic(),ROIs200_s2_summer.size())
Map.addLayer(ROIs200_s2_summer.mosaic(),{min:0,max:5000,bands:["B4","B3","B2"]},"ROIs200_s2_summer.mosaic()");
...
//查询landsat8影像		  	           
var ROIs200_L8_summer = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2')
                    .filterBounds(roi)
		  	            .filterDate("2021-06-01","2021-08-31")
		  	            .filter(ee.Filter.lt("CLOUD_COVER",1))
		  	            .select(["SR_B4","SR_B3","SR_B2"])
var ROIs200_L8_summer_List = ROIs200_L8_summer.toList(ROIs200_L8_summer.size())
var L8_num = ROIs200_L8_summer.size()
print('ROIs200_L8_summer',ROIs200_L8_summer,ROIs200_L8_summer_List,ROIs200_L8_summer.mosaic(),ROIs200_L8_summer.size())
// Map.addLayer(ROIs100_L8_spring.mosaic(),{min:5000,max:12000,bands:["SR_B4","SR_B3","SR_B2"]},'ROIs100_L8_spring.mosaic()')
Map.addLayer(ROIs200_L8_summer.mosaic(),{min:5000,max:15000,bands:["SR_B4","SR_B3","SR_B2"]},'ROIs200_L8_summer.mosaic()')
...
//求影像交集
var intersection_s2_L8 = ROIs200_s2_summer.mosaic().updateMask(ROIs200_L8_summer.mosaic().mask())
...
var intersection_s1_s1s2L8 = ROIs200_s1_summer.mosaic().updateMask(intersection_s2_L8.select('B2').mask())
...
var intersection_s2_s1s2L8 = ROIs200_s2_summer.mosaic().updateMask(intersection_s1_s1s2L8.select('VV').mask())
...
var intersection_L8_s1s2L8 = ROIs200_L8_summer.mosaic().updateMask(intersection_s1_s1s2L8.select('VV').mask())
