...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='EGASR',
...
def main():
    ...
    # test
    net.mfeNew_validate(epoch=100, modelpath='./Result/EGASR/model/generator_param.pkl')
