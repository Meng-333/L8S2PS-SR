import torch
import os, argparse
from model.transenet import TransENetModel                #遥感影像SR模型2022
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='TransENetModel',
                        choices=['DRCAN', 'DSSR', 'AMSSRN', 'EGASR', 'ESRGAN', 'SRAGAN', 'NDSRGAN', 'SRADSGAN', 'SwinIR',
                                 'TransENet', 'HAT', 'TTST', 'EDiffSR', 'FastDiffSR', 'CNN-DiffSR'], help='The type of model')
    parser.add_argument('--root_dir', type=str, default='/g12238036mfe/mfe/a800/L8S2PS-SR/MSI_SR_model_x3/')
    parser.add_argument('--data_dir', type=str, default='/g12238036mfe/mfe/a800/L8S2PS-SR/dataset/')
    ...
    parser.add_argument('--crop_size', type=int, default=240, help='Size of cropped HR image')
    ...
    parser.add_argument('--scale_factor', type=int, default=3, help='Size of scale factor')
    ...
    parser.add_argument('--test_crop_size', type=int, default=240, help='Size of cropped HR image')
    parser.add_argument('--n_cpu', type=int, default=8, help='number of cpu threads to use during batch generation')
    parser.add_argument('--hr_height', type=int, default=240, help='size of high res. image height')
    parser.add_argument('--hr_width', type=int, default=240, help='size of high res. image width')
    ...
    parser.add_argument('--max_train_samples', type=int, default=20000, help='Max training samples')
    # srragan
...
def main():
    ...
    net.mfeNew_total_ops(modelpath="./Result/TransENetModel/model/generator_param.pkl")
