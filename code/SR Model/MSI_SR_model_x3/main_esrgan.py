import torch
import os, argparse
from model.esrgan import ESRGAN     # 本文提出的方法
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='ESRGAN',
                        choices=['DRCAN', 'DSSR', 'AMSSRN', 'EGASR', 'ESRGAN', 'SRAGAN', 'NDSRGAN', 'SRADSGAN',
                                 'SwinIR',
                                 'TransENet', 'HAT', 'TTST', 'EDiffSR', 'FastDiffSR', 'CNN-DiffSR'],
...
def main():
    ...
    # test
    net.mfeNew_validate(epoch=100, modelpath='./Result/ESRGAN/model/generator_param.pkl')
