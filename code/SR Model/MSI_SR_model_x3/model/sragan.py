...
class Discriminator(nn.Module):
    def __init__(self, in_channels=3, attention=False):
...
class SRAGAN(object):
    ...
    def mfeNew_validate(self, epoch=100, modelpath=None):
        ...
        # load model
        self.generator = GeneratorResNet(ResidualBlock_Block_WithAttention, n_residual_blocks=12, n_basic_blocks=5,
                                         # 默认n_residual_blocks=12  n_basic_blocks=5
                                         rla_mode='CA-SA', bla_mode='CA-SA', ga_mode='CA-SA', pool_mode='Avg|Max',
