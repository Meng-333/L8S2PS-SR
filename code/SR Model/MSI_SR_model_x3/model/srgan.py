...
class ESRGAN(object):
    ...
    def load_dataset(self, dataset='train'):
        ...
        if dataset == 'train':
            ...
            # print('esrgan______________________train_set', train_set)
    ...
    def train(self):
        ...
        for epoch in range(self.epoch, self.num_epochs):
            ...
            for i, (input, target, bc_input, imgpath) in enumerate(dataloader):
                #print('______________esrgan______________318', input.shape, target.shape, bc_input.shape, imgpath)
    ...
    def mfeNew_validate(self, epoch=100, modelpath=None):
        ...
        print_rlt['bicubic_ergas'] = avg_bicubic_ergas
        print_rlt['bicubic_lpips'] = avg_bicubic_lpips
        print_rlt['esrgan_mse'] = avg_srcnn_mse
        print_rlt['esrgan_psnr'] = avg_srcnn_psnr
        print_rlt['esrgan_ssim'] = avg_srcnn_ssim
        print_rlt['esrgan_ergas'] = avg_srcnn_ergas
        print_rlt['esrgan_lpips'] = avg_srcnn_lpips
        self.logger.print_format_results('val', print_rlt)
        print('-----------------------------------')
