import torch
import os, argparse
from model.ttst import TTST               #遥感影像SR模型2022
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='TTST',
...
def main():
    ...
    # test
    net.mfeNew_validate(epoch=100, modelpath='./Result/TTST/model/generator_param.pkl')
